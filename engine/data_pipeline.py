...
EXCLUDED_PATTERNS = [
    'BEES', 'ETF', 'NIFTY', 'GOLD', 'SILVER', 'LIQUID', 'LIQID', 'GILT', 'CPSE', 'BHARAT22',
    'INDEX', 'IVZ', 'DUMMY', 'MON100', 'MOM100', 'MONQ50', 'MASPTOP50', 'HDFCMF', 'ICICIM', 'UTIMF',
    'KOTAKM', 'N100', 'TOP100', 'NEXT50', 'MIDCAP', 'SMLCAP', 'MAFANG', 'FMCG',
    'CONSUMP', 'AUTO', 'BANK', 'INFRA', 'IT', 'PHARMA', 'HEALTH', 'COMMOD', 'GROWW', 'TATAHEDGE'
]
